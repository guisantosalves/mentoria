...
type FilterResultScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  "FilterResult"
>;
type FilterResultScreenRouteProp = RouteProp<
  RootStackParamList,
  "FilterResult"
>;
...
const FilterResultScreen: React.FC<FilterResultScreenProps> = ({
  route,
  navigation,
}) => {
